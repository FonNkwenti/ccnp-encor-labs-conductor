...
class TestLab01Structure(unittest.TestCase):
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-01-basic-adjacency/scripts/refresh_lab.py",
            "labs/eigrp/lab-01-basic-adjacency/scripts/fault_inject_1.py",
            "labs/eigrp/lab-01-basic-adjacency/scripts/fault_inject_2.py",
            "labs/eigrp/lab-01-basic-adjacency/scripts/fault_inject_3.py"
        ]
