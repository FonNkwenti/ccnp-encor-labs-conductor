...
class TestLab03Structure(unittest.TestCase):
    def test_files_exist(self):
        base_path = "labs/eigrp/lab-03-route-summarization"
    ...
    def test_scripts_syntax(self):
        scripts = [
            "labs/eigrp/lab-03-route-summarization/scripts/refresh_lab.py",
            "labs/eigrp/lab-03-route-summarization/scripts/fault_inject_1.py",
            "labs/eigrp/lab-03-route-summarization/scripts/fault_inject_2.py",
            "labs/eigrp/lab-03-route-summarization/scripts/fault_inject_3.py"
        ]
