#!/usr/bin/env python3
"""
setup_lab.py — OSPF Lab 08: OSPFv3 Dual-Stack Integration
Loads initial-configs onto R1, R2, R3, R6 via GNS3 console (Netmiko telnet).
"""
...
DEVICES = [
    ...
    {"name": "R6", "host": "127.0.0.1", "port": 5006},
]
...
def main() -> None:
    print("=" * 60)
    print("OSPF Lab 08 — OSPFv3 Dual-Stack Integration")
    ...
    print("=" * 60)
    print("Done. Verify with: show ospfv3 neighbor")
    print("=" * 60)
