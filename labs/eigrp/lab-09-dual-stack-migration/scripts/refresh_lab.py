...
if __name__ == "__main__":
    ...
    devices = [
        ...
        ("R4", 5004, os.path.join(lab_dir, "initial-configs/R4.cfg")),
        ("R5", 5005, os.path.join(lab_dir, "initial-configs/R5.cfg")),
        ("R6", 5006, os.path.join(lab_dir, "initial-configs/R6.cfg")),
        ("R7", 5007, os.path.join(lab_dir, "initial-configs/R7.cfg")),
    ]
    refresher = LabRefresher(devices)
    refresher.run()
    print("\nLab 09 has been refreshed.")
