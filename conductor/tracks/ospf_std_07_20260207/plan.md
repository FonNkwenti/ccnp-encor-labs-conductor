...
- [ ] Task: Review `labs/ospf/baseline.yaml` for Lab 07 requirements.
- [ ] Task: Design Skynet Global scenario narrative for OSPF Lab 07.
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Design' (Protocol in workflow.md)

## Phase 2: Workbook & Config Implementation
- [ ] Task: Initialize lab directory `labs/ospf/lab-07-*/`.
