# Implementation Plan: Implement OSPF Lab 05

## Phase 1: Lab Design & Topology
- [ ] Task: Review `labs/ospf/baseline.yaml` for Lab 05 requirements.
- [ ] Task: Design Skynet Global scenario narrative for OSPF Lab 05.
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Design' (Protocol in workflow.md)

## Phase 2: Workbook & Config Implementation
- [ ] Task: Initialize lab directory `labs/ospf/lab-05-*/`.
- [ ] Task: Create `topology.drawio` with active devices.
- [ ] Task: Generate `initial-configs/` from Lab 04 solutions.
