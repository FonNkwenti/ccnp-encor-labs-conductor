...
- [ ] Task: Review `labs/ospf/baseline.yaml` for Lab 06 requirements.
- [ ] Task: Design Skynet Global scenario narrative for OSPF Lab 06.
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Design' (Protocol in workflow.md)

## Phase 2: Workbook & Config Implementation
- [ ] Task: Initialize lab directory `labs/ospf/lab-06-*/`.
- [ ] Task: Create `topology.drawio` with active devices.
- [ ] Task: Generate `initial-configs/` from Lab 05 solutions.
